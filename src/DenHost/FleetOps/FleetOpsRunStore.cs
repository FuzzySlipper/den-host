...
public interface IFleetOpsRunStore
{
    ...
    void UpdateRun(string runId, int? exitCode, string status,
        IReadOnlyList<string>? stdoutTail, IReadOnlyList<string>? stderrTail, string? errorMessage);
}
...
public sealed class InMemoryFleetOpsRunStore : IFleetOpsRunStore
{
    ...
    public void UpdateRun(string runId, int? exitCode, string status,
        IReadOnlyList<string>? stdoutTail, IReadOnlyList<string>? stderrTail, string? errorMessage)
    {
