...
public sealed record FleetOpsOptions
{
    ...
    /// <summary>Cooldown seconds after a real restart/update action finishes.</summary>
    public int RestartActionCooldownSeconds { get; init; } = 30;

    /// <summary>HTTP listen address for the FleetOps API.</summary>
    public string ListenAddress { get; init; } = "http://0.0.0.0:5400";

    /// <summary>Whether the FleetOps HTTP API is enabled.</summary>
