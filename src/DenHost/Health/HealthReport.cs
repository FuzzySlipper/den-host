...
/// identity, Core/Channels reachability, and configured harness
/// module availability. The host does not derive a "running" /
/// "stopped" status from local logs; only the live probe results
/// and the harness module's own IsAvailable() determine status.
/// </summary>
    ...
    DateTimeOffset GeneratedAt)
{
    ...
    /// means: Core reachable, Channels reachable, every enabled
    /// harness module reports itself available. Disabled modules
